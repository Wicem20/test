...
#include "../Convertisseur/mafenetre.h"
...
QT_MOC_LITERAL(1, 10, 10), // "actualiser"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 9), // "convertir"
QT_MOC_LITERAL(4, 32, 8) // "permuter"

    },
    "MaFenetre\0actualiser\0\0convertir\0"
    "permuter"
};
...
void MaFenetre::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MaFenetre::actualiser)) {
                *result = 0;
                return;
            }
        }
